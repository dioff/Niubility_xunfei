...
def parser():
    ...
    parser.add_argument("--weights", default="/home/ucar/catkin_test_ws/src/darknet-master/total/yolov3-tiny_40000.weights",
    ...
    parser.add_argument("--config_file", default="/home/ucar/catkin_test_ws/src/darknet-master/total/yolov3-tiny.cfg",
                        help="path to config file")
    parser.add_argument("--data_file", default="/home/ucar/catkin_test_ws/src/darknet-master/total/obj.data",
...
def save_result():
    ...
    with open('/home/ucar/catkin_test_ws/src/image/1_2.txt','r') as f:
        for line in f.readlines():
            result_list1.append(line.split()[0])
    with open('/home/ucar/catkin_test_ws/src/image/1_3.txt','r') as f:
        for line in f.readlines():
            result_list1.append(line.split()[0])
    ...
    with open('/home/ucar/catkin_test_ws/src/image/2_2.txt','r') as f:
        for line in f.readlines():
            result_list2.append(line.split()[0])
    with open('/home/ucar/catkin_test_ws/src/image/2_3.txt','r') as f:
        for line in f.readlines():
            result_list2.append(line.split()[0])
    with open('/home/ucar/catkin_test_ws/src/image/2_4.txt','r') as f:
        for line in f.readlines():
            result_list2.append(line.split()[0])
    ...
    with open('/home/ucar/catkin_test_ws/src/image/3_1.txt','r') as f:
        for line in f.readlines():
            result_list3.append(line.split()[0])
    with open('/home/ucar/catkin_test_ws/src/image/3_2.txt','r') as f:
        for line in f.readlines():
            result_list3.append(line.split()[0])
    with open('/home/ucar/catkin_test_ws/src/image/3_3.txt','r') as f:
        for line in f.readlines():
            result_list3.append(line.split()[0])
    ...
    with open('/home/ucar/catkin_test_ws/src/image/4_1.txt','r') as f:
        for line in f.readlines():
            result_list4.append(line.split()[0])
    with open('/home/ucar/catkin_test_ws/src/image/4_2.txt','r') as f:
        for line in f.readlines():
            result_list4.append(line.split()[0])
    with open('/home/ucar/catkin_test_ws/src/image/4_3.txt','r') as f:
        for line in f.readlines():
            result_list4.append(line.split()[0])
    ...
    with open('/home/ucar/catkin_test_ws/src/image/5_4.txt','r') as f:
        for line in f.readlines():
            result_list5.append(line.split()[0])
    with open('/home/ucar/catkin_test_ws/src/image/5_5.txt','r') as f:
        for line in f.readlines():
            result_list5.append(line.split()[0])
    with open('/home/ucar/catkin_test_ws/src/image/5_6.txt','r') as f:
        for line in f.readlines():
            result_list5.append(line.split()[0])
