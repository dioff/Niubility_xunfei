...
waypoints = {
    ...
    'E1': (2.96, -1.05, 0.37, 0.93),
    'E2': (2.96, -1.18, -0.95, 0.32),
    # 'E3': (2.94, -1.21, 0.96, 0.30),

    'D1': (2.79, -3.53, 0.20, 0.98),
    # 'D2': (2.79, -3.42, -0.71, 0.71),
    'D3': (2.79, -3.50, 0.98, 0.22),

    'must': (5.13, -2.56, 0.71, 0.70),

    'C1': (4.36, -0.91, -0.21, 0.98),
    'C2': (4.75, -0.65, -0.81, 0.59),

    'B1': (4.30, -4.00, 0.13, 0.99),
    'B2': (4.66, -4.00, 0.99, 0.12),
    'B4': (4.66, -4.00, 0.99, 0.12),
