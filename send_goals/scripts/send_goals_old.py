...
# 巡逻点
waypoints=[
    (2.80, -0.56, -0.12, 0.99),  # E
    (2.80, -0.56, -0.42, 0.90),  # E
    (2.80, -0.56, -0.69, 0.72),  # E
    (2.80, -0.56, -0.92, 0.38),  # E

    (2.79, -3.68, 0.26, 0.97),   # D
    (2.79, -3.68, -0.5, 0.86),   # D
    (2.79, -3.68, -0.70, 0.71),   # D
    (2.79, -3.68, -0.85, 0.53),   # D
    (2.79, -3.68, -0.99, 0.05),   # D
    
    # (5.13, -1.97, 0.71, 0.70),  # C 
    # (5.13, -1.97, 0.85, 0.53),  # C 
    # (5.13, -1.97, 0.94, 0.33),  # C 
    # (5.13, -1.97, 1.0, 0.02),   # C 

    (4.98, -3.49, -0.71, 0.71), # B
    (4.98, -3.49, -0.87, 0.49), # B
    (4.98, -3.49, -0.95, 0.32), # B
    (4.98, -3.49, 1.00, 0.04),   # B
    
    (2.64, 0.07, 0.70, 0),  # 拐点

    (0.82, -0.43, -0.70, 0.71),  # 上坡1   
    
    (0.82, -3.00, -0.70, 0.71),  # 果实识别区
    # (0.82, -3.46, -0.40, 0.92),  # 果实识别区
    # (0.82, -3.46, -0.90, 0.44),  # 果实识别区
   
    # (1.40, -5.00, -0.36, 0.93),  # 左上
     
    (0.15, -4.94, -0.91, 0.41),  # 右上
      
    (0.82, -2.30, 0.33, 0.95),  # 左下
       
    (0.82, -2.30, 0.95, 0.30),  # 右下
  
  
    (0.82, -2.30, 0.71, 0.70),  # 上坡2
    (0.80, -0.36, 0.71, 0.70),  # 下坡
    (-0.10, 0.05, 0.02, 1.00)  # 回家
]
